...
$selectData = 'SELECT employee.emp_name,employee.id,employee.email,employee.phone,employee.address,employee.dept_id,department.dept_name FROM employee LEFT JOIN department ON employee.dept_id = department.id';
    ...
    <div class="flex flex-row ">
        <div class="flex flex-col  space-y-5 justify-between min-h-screen w-60 px-2 py-4 bg-gray-50">
            ...
            <div class="flex flex-col flex-auto">
                ...
                <div class="p-2 hover:bg-pink-100">
                    <div class="flex flex-row space-x-3">
                        <a href="dashboardDepartment.php" class="font-regular text-gray-500 hover:text-pink-600 uppercase text-bold text-center">Department</a>
                    </div>
                </div>
        ...
        <div class="flex-auto ">
            <div class="flex flex-col">
                <div class="flex justify-end align-center bg-white h-24 p-2 drop-shadow-2xl">
                ...
                <div class="bg-blue-50 min-h-screen">
                    ...
                    <div class="flex justify-between ">
                        <div class="p-4 font-bold text-gray-600 uppercase">Employee details</div>
                        <a href="employee.php" class="border border-solid border-blue-900 px-4  rounded-full bg-blue-400 uppercase self-center py-1 mr-5"> ADD +</a>
                    </div>
                                    ...
                                    <?php foreach ($data as $info) : ?>
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                <?php echo ucwords($info['emp_name']); ?>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                <?php echo $info['email']; ?>
                                            </td>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                <?php echo ucwords($info['address']); ?>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                <?php echo $info['dept_name']; ?>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-left text-sm font-medium">
                                                <a href="editEmployee.php?id=<?php echo $info['id']; ?>" class="text-black hover:text-indigo-900 p-1 border border-solid border-black rounded-full mr-3 bg-blue-400">Edit</a>
                                                <a href="dashboard.php?id=<?php echo $info['id']; ?>" class="text-black hover:text-indigo-900 p-1 border border-solid border-black rounded-full mr-3 bg-blue-400">Delete</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
